...
var Button = function Button(_ref) {
  var _ref$node = _ref.node,
      node = _ref$node === void 0 ? 'button' : _ref$node,
      ...
      icon = _ref.icon,
      props = _objectWithoutProperties(_ref, ["node", "children", "className", "fab", "modal", "flat", "floating", "large", "small", "disabled", "waves", "tooltip", "tooltipOptions", "icon"]);
