...
var Dropdown = function Dropdown(_ref) {
  var children = _ref.children,
      ...
      id = _ref.id,
      props = _objectWithoutProperties(_ref, ["children", "className", "trigger", "options", "id"]);

  var finalId = id || "Dropdown_".concat((0, _idgen.default)());
  ...
  (0, _react.useEffect)(function () {
    var instance = M.Dropdown.init(document.querySelector("[data-target=\"".concat(finalId, "\"]")), finalOptions);
    return function () {
