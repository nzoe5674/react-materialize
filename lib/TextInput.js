...
var TextInput = _react.default.forwardRef(function (props, ref) {
  ...
  var children = props.children,
      ...
      type = props.type,
      _props$id = props.id,
      id = _props$id === void 0 ? "TextInput-".concat((0, _idgen.default)()) : _props$id,
      other = _objectWithoutProperties(props, ["children", "s", "m", "l", "xl", "disabled", "noLayout", "placeholder", "icon", "label", "inputClassName", "success", "error", "password", "email", "validate", "defaultValue", "value", "type", "id"]);
