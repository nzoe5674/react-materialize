...
var Modal = function Modal(_ref) {
  var _ref$actions = _ref.actions,
      actions = _ref$actions === void 0 ? [/*#__PURE__*/_react.default.createElement(_Button.default, {
    waves: "green",
    modal: "close",
    flat: true
  }, "Close")] : _ref$actions,
      _ref$bottomSheet = _ref.bottomSheet,
      bottomSheet = _ref$bottomSheet === void 0 ? false : _ref$bottomSheet,
      children = _ref.children,
      _ref$fixedFooter = _ref.fixedFooter,
      fixedFooter = _ref$fixedFooter === void 0 ? false : _ref$fixedFooter,
      header = _ref.header,
    ...
    endingTop: '10%'
      ...
      _ref$root = _ref.root,
      root = _ref$root === void 0 ? typeof window !== 'undefined' ? document.body : null : _ref$root,
      id = _ref.id,
      props = _objectWithoutProperties(_ref, ["actions", "bottomSheet", "children", "fixedFooter", "header", "className", "trigger", "options", "open", "root", "id"]);

  // Compute the id only once; if id isn't provided, auto-generate one.
  var finalIdRef = (0, _react.useRef)(id || "Modal-".concat((0, _idgen.default)()));
  var finalId = finalIdRef.current; //const finalId = useMemo(() => id || `Modal-${idgen()}`, [id]);
